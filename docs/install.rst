...
Step by Step for Ubuntu:
    ...
    - wget https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.7.0-linux-x86_64.tar.gz.sha512
...
Step by Step for CentOS/RedHat:
    ...
    - curl -O https://artifacts.elastic.co/downloads/elasticsearch/elasticsearch-7.7.0.tar.gz
    - tar xfvz elasticsearch-7.7.0.tar.gz
    - cd elasticsearch
    - bin/elasticsearch
